				...
				<div class="row">
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" >
						<div class="block">							
							...
							<div class="content text-center">
								<h3 class="ddd"><?php echo $characteristics1 ?></h3>								
								<p><?php echo $char_description1 ?></p>
							</div>
						</div>
					</div> 
					<!-- End About item -->
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="250ms">
						<div class="block">
							...
							<!-- Express About Yourself -->
							<div class="content text-center">
								<h3><?php echo $characteristics2 ?></h3>
								<p><?php echo $char_description2 ?></p>
							</div>
						</div>
					</div> 
					<!-- End About item -->
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="500ms">
						<div class="block kill-margin-bottom">
							...
							<!-- Express About Yourself -->
							<div class="content text-center">
								<h3><?php echo $characteristics3 ?></h3>
								<p><?php echo $char_description2 ?></p>
							</div>
						</div>
					</div> 
		...
		<div class="row">
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms">
				<div class="service-block text-center">
					...
					<h3><?php echo $ServicesTitle1 ?></h3>
					<p><?php echo $ServicesDescription1 ?></p>
				</div>
			</article>
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
				<div class="service-block text-center">
					...
					<h3><?php echo $ServicesTitle2 ?></h3>
					<p><?php echo $ServicesDescription2 ?></p>
				</div>
			</article>
            <!-- End Single Service Item -->
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
				<div class="service-block text-center">
					...
					<h3><?php echo $ServicesTitle3 ?></h3>
					<p><?php echo $ServicesDescription3 ?></p>
				</div>
			</article>
			<!-- End Single Service Item -->
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
				<div class="service-block text-center">
					...
					<h3><?php echo $ServicesTitle4 ?></h3>
					<p><?php echo $ServicesDescription4 ?></p>
				</div>
			</article>
			<!-- End Single Service Item -->
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
				<div class="service-block text-center">
					...
					<h3><?php echo $ServicesTitle5 ?></h3>
					<p><?php echo $ServicesDescription5 ?></p>
				</div>
			</article>
			<!-- End Single Service Item -->
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
				<div class="service-block text-center kill-margin-bottom">
					...
					<h3><?php echo $ServicesTitle6 ?></h3>
					<p><?php echo $ServicesDescription6 ?></p>
				</div>
			</article>
			<!-- End Single Service Item -->
...
<section id="our-team" class="section">
			...
			<div class="col-md-3 col-sm-6 col-xs-12  wow fadeInDown" data-wow-duration="500ms">
               <div class="team-member">
					<div class="member-photo">
						...
						?>
						<img class="img-responsive" src=<?php echo "'./images/".$data2['imgName']."'"?> alt="<?php echo $data['memberName']?>" style="object-fit:cover; object-position: center; width: 300px; height:350px">
						<!-- /member photo -->
						<?php }?>
	...
	<div class="text-center">
		<a href="team.php" class="text-center btn btn-main">View All Team Members</a>
	</div>
</section>   <!-- End section -->
		...
		<div class="row">
			...
			<?php 
				...
				for ($i=0; $i < sizeof($blogs); $i++) {
					$id=$blogs[$i]['id']; 
					$featured_image=$blogs[$i]['featured_image'];
					$title=$blogs[$i]['blog_title'];
					$primary_content1=$blogs[$i]['primary_content'];
					$primary_content= substr($primary_content1, 0, 250);

					echo "<article class='col-md-4 col-sm-6 col-xs-12 clearfix wow fadeInUp' data-wow-duration='500ms'>
					<div class='post-block'>
						<div class='media-wrapper'>
							<img class='blog-image' src='images/blog/$featured_image' class='img-responsive'>
						</div>
						<div class='content'>
							<h3><a href=''>$title</a></h3>
							<p>$primary_content</p>
							<a class='btn btn-transparent' href='blog-single.php?id=$id'>Read more</a>
						</div>
					</div>						
				</article>";
...
<footer id="footer" class="bg-one">
	<div class="container">
		...
		<!-- Google Map API -->
		<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDdP7Wmfvwwn76KWGc65TAu4RE9rDbxdcA"></script>
		<!-- Sticky Nav -->

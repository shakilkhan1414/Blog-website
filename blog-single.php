<?php 
  include 'config/function.php';
	...
	$primary_content=$blog['primary_content'];
	$secondary_image=$blog['secondary_image'];
	$secondary_content=$blog['secondary_content'];
	$date=$blog['date'];
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <ul class="list-inline mb-50">
                    <li class="list-inline-item"><?=$author_name?></li>
					<li>|</li>
                    <li class="list-inline-item"><?=$date?></li>
                </ul>
                <img class="img-fluid mb-50" src="images/blog/<?=$featured_image?>" alt="blog-image">
            </div>
            <div class="col-lg-12">
                <p><?=$primary_content?></p>
                <div class="text-center"  style="margin-top: 50px;">
                    <img class="img-fluid mb-50" src="images/blog/<?=$secondary_image ?>" alt="image">
                </div>

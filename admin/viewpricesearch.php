...
$searching = $_GET['searching'];
    ...
    $sql ="select * from pricing WHERE pricingID = '". $searching ."'";  // sql command
    ...
    <p><a href="updateprice.php?pricingID=<?php echo  $row['pricingID'] ; ?>">Update Pricing </a> &ensp;
        <a href="deleteprice.php?pricingID=<?php echo  $row['pricingID'] ; ?>">Delete Pricing </a></p>
        </table>
        <form method="POST">
...
<a href="insertprice.php">Add plan and details </a>

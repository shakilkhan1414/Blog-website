...
<!-- 
    ...
    <div class="container">
      ...
      <nav class="collapse navbar-collapse navbar-right" role="Navigation">
        <ul id="nav" class="nav navbar-nav navigation-menu">
		  <li><a href="../admin/updateprofile.php?userid=<?php echo $_SESSION['UserID'] ?>"><img src="../images/person.png" alt="person" class="profileicon"/></a></li>
          <li><a data-scroll href="../index.php#body">Home</a></li>
  ...
  ==================================== -->
  <div class="title">
  <h1>Hi, <?php echo $_SESSION['name'] ?>! Welcome back to your dashboard! </h1>
  </div>	

  <div class="avatar-container">	
  	<img src="../images/<?php echo $_SESSION['avatar'] ?>" class="avatar"/>
  </div>
  <div class="box-profile"> 
	  		<h2 class="username"><?php echo $_SESSION['Username'] ?> </h2> <br>
			<p style="color:whitesmoke; text-align:center; font-size: 1.15em;"> User type: <?php echo $_SESSION['UserType'] ?> </p>
			<p style="color:whitesmoke; text-align:center; font-size: 1.15em;"> Email: <?php echo $_SESSION['UserID'] ?> </p>
			<p style="color:whitesmoke; text-align:center; font-size: 1.15em;"> Location: <?php echo  $_SESSION['State']?>, <?php echo $_SESSION['City']?>, <?php echo $_SESSION['Country']?> </p>
			<p style="color:whitesmoke; text-align:center; font-size: 1.15em;"> Created time: <?php echo $_SESSION['created_time'] ?> </p> <br><br>
			<p style="color:whitesmoke; text-align:center; font-size: 1.15em;"> 
			<a data-scroll href="../admin/updateprofile.php?userid=<?php echo $_SESSION['UserID'] ?>">--- Edit User Profile ---</a> </p>
  </div>
